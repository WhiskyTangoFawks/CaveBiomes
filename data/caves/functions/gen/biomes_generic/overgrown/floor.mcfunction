...
execute if score $gen.out_1 cave_data matches 000..099 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run function caves:decor/slab
execute if score $gen.out_1 cave_data matches 200..299 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run function caves:decor/slab
