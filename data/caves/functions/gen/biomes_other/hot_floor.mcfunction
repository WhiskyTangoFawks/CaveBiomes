...
execute if score $gen.in_0 cave_data matches 61 if score $gen.out_1 cave_data matches 001..50 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run function caves:decor/slab
